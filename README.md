...
生成时 Skill 会展示预览让你选，你也可以随时让 Agent 整套换掉。下表每套主题的预览，都是从它自己的版式库里挑出的 4 个正文版式（图表、分析模型、卡片、目录等），**全部由这个 Skill 真实渲染，非示意图**：

| 预览 | 主题 | 适配场景与人群 |
|------|------|----------------|
| <img src="assets/readme/themes/theme01.png" width="330" alt="轻拟态风内页预览"> | **theme01 轻拟态风**（84 页） | 产品介绍、企业汇报、方案说明、轻量级发布；创业团队、产品经理、销售顾问 |
| <img src="assets/readme/themes/theme02.png" width="330" alt="炫光紫绿风内页预览"> | **theme02 炫光紫绿风**（74 页） | 科技发布会、AI / 自动驾驶 / 机器人主题、增长故事；科技公司创始人、技术负责人 |
| <img src="assets/readme/themes/theme03.png" width="330" alt="深浅代码风内页预览"> | **theme03 深浅代码风**（77 页） | 技术方案、开发者大会、系统架构、AI 工程实践；工程师、架构师、开发者社区 |
| <img src="assets/readme/themes/theme04.png" width="330" alt="玻璃糖果风内页预览"> | **theme04 玻璃糖果风**（74 页） | 年轻化品牌、消费产品、创意提案、社媒感内容；品牌团队、设计师、内容创作者 |
| <img src="assets/readme/themes/theme05.png" width="330" alt="色谱图表风内页预览"> | **theme05 色谱图表风**（94 页） | 数据报告、市场分析、KPI 复盘、行业研究；数据分析师、咨询顾问、研究员 |
| <img src="assets/readme/themes/theme06.png" width="330" alt="深色图谱风内页预览"> | **theme06 深色图谱风**（83 页） | 高密度数据展示、战略分析、科技 / 金融 / 产业报告；战略团队、投资人、高管汇报者 |
| <img src="assets/readme/themes/theme07.png" width="330" alt="冷白调研风内页预览"> | **theme07 冷白调研风**（71 页） | 调研报告、白皮书、竞品分析、学术 / 政策型表达；研究机构、咨询团队、智库 |
| <img src="assets/readme/themes/theme08.png" width="330" alt="黑金实验风内页预览"> | **theme08 黑金实验风**（84 页） | 高端发布、品牌提案、实验性概念、奢华科技叙事；高端品牌、创意总监 |
| <img src="assets/readme/themes/theme09.png" width="330" alt="深蓝杂志风内页预览"> | **theme09 深蓝杂志风**（111 页） | 品牌故事、人物访谈、企业形象册、深度专题；公关团队、媒体编辑、创始人 |
| <img src="assets/readme/themes/theme10.png" width="330" alt="金色指数风内页预览"> | **theme10 金色指数风**（95 页） | 金融数据、投资报告、商业指数、年度榜单；投资机构、金融分析师、商业媒体 |
| <img src="assets/readme/themes/theme11.png" width="330" alt="高能增长风内页预览"> | **theme11 高能增长风**（87 页） | 增长复盘、商业计划、融资路演、市场扩张方案；创业者、增长团队、VC/PE 路演 |
| <img src="assets/readme/themes/theme12.png" width="330" alt="声波霓虹风内页预览"> | **theme12 声波霓虹风**（86 页） | 音乐娱乐、潮流活动、直播内容、年轻化发布；娱乐品牌、活动策划、潮流消费品牌 |
...
| 豆包 | 支持 | 刚支持 Skill 的豆包也能跑出很好的效果（见下图） |
| Cursor / 其他本地 Agent | 可用 | 需要能读写文件并执行 shell 命令 |
| 普通网页 Chatbot | 不推荐 | 生成器需要本地 Node.js 环境 |

在豆包里调用 dashiai-ppt：

![豆包中调用 dashiai-ppt 生成 PPT](assets/readme/doubao.gif)
...
从输入提示词到生成完整 PPT（2.5 倍速）：

![Codex 中生成完整 PPT 流程](assets/readme/generate-flow.gif)
